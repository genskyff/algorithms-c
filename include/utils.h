...
// [start, end)
void show(elem_t *arr, size_t len);
void show_slice(elem_t *arr, size_t start, size_t end);

void copy(elem_t *dst, elem_t *src, size_t len);
void copy_slice(elem_t *dst, size_t d_start, size_t d_end, elem_t *src,
